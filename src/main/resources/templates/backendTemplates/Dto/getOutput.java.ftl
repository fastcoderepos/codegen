...
<#list Fields as fkey,fvalue>
 <#if fvalue.isPrimaryKey!false>
  ...
  private [=fvalue.fieldType?cap_first] [=ClassName?uncap_first][=fkey?cap_first];
  
  public [=fvalue.fieldType?cap_first] get[=ClassName?cap_first][=fkey?cap_first]() {
  	return [=ClassName?uncap_first][=fkey?cap_first];
  }

  public void set[=ClassName?cap_first][=fkey?cap_first]([=fvalue.fieldType?cap_first] [=ClassName?uncap_first][=fkey?cap_first]){
  	this.[=ClassName?uncap_first][=fkey?cap_first] = [=ClassName?uncap_first][=fkey?cap_first];
  }
  </#if> 
 </#if> 
</#list>
