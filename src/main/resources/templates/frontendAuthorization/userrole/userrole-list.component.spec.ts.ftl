...
import { I[=AuthenticationTable]role, [=AuthenticationTable]roleService, [=AuthenticationTable]roleDetailsComponent, [=AuthenticationTable]roleListComponent, [=AuthenticationTable]roleNewComponent } from './index';

describe('[=AuthenticationTable]roleListComponent', () => {
  let fixture:ComponentFixture<[=AuthenticationTable]roleListComponent>;
  let component:[=AuthenticationTable]roleListComponent;
  let el: HTMLElement;
  let constData:I[=AuthenticationTable]role[] = [
    {   
      roleId: 1,
  ...
  let data: I[=AuthenticationTable]role[] = [... constData];
  ...
  describe('Unit tests', () => {
    ...
    beforeEach(async(() => {
      ...
      TestBed.configureTestingModule({
        declarations: [
          [=AuthenticationTable]roleListComponent       
        ],
        imports: [TestingModule],
        providers: [
          [=AuthenticationTable]roleService,      
          ChangeDetectorRef,
        ],
    ...
    beforeEach(() => {
      fixture = TestBed.createComponent([=AuthenticationTable]roleListComponent);
  ...
  describe('Integration tests', () => {
    ...
    beforeEach(async(() => {
      ...
      TestBed.configureTestingModule({
        declarations: [
          [=AuthenticationTable]roleListComponent,
          [=AuthenticationTable]roleNewComponent,
          [=AuthenticationTable]roleDetailsComponent
        ].concat(EntryComponents),
        imports: [
          TestingModule,
          RouterTestingModule.withRoutes([
            { path: '[=AuthenticationTable?uncap_first]role', component: [=AuthenticationTable]roleListComponent },
            { path: '[=AuthenticationTable?uncap_first]role/:id', component: [=AuthenticationTable]roleDetailsComponent }
          ])
        ],
        providers: [
          [=AuthenticationTable]roleService,
    ...
    it('should verify that redirected to details page when edit button is clicked', async () => {
      ...
      expect(location.path()).toBe(`/[=AuthenticationTable?uncap_first]role/${ServiceUtils.encodeIdByObject(data[0], component.primaryKeys)}`);
    });
